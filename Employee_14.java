...
public class Employee {
	...
	public static void main(String[] args) {
		...
		Map<Department, List<Employee>> employeeListByDepartment = EMPLOYEE_LIST.stream()
				.collect(Collectors.groupingBy(Employee::getDepartment));

		Set<Entry<Department, List<Employee>>> entrySet = employeeListByDepartment.entrySet();
