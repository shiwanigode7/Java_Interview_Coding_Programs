...
public class Employee {
	...
	public static void main(String[] args) {
		...
		Optional<Employee> youngestMaleEmployeeInSalesWrapper = EMPLOYEE_LIST.stream()
				.filter(employee -> employee.getGender() == Gender.MALE && employee.getDepartment() == Department.SALES)
				.min(Comparator.comparingInt(Employee::getAge));

		Employee youngestMaleEmployeeInSalesDepartment = youngestMaleEmployeeInSalesWrapper.get();
